...
public class JankenController {
  ...
  String match(@RequestParam Integer id, Principal prin, ModelMap model) {
    System.out.println("===================");
    System.out.println(user.selectUserById(id).getId());
    System.out.println("===================");
  ...
  @GetMapping(path = "/fight", params = { "hand", "user_name", "opponent_id" })
  String matchPost(@RequestParam Integer hand, @RequestParam String user_name, @RequestParam Integer opponent_id,
      ModelMap model) {
    ...
    enum Hand {
      ...
      public static Hand fromValue(int value) {
        ...
        throw new IllegalArgumentException("不正な値: " + value);
      }
    }
    ...
    matches.insertMatch(user.selectUserByName(user_name).getId(),
        opponent_id,
        Hand.fromValue(userHand.getValue()).toString(),
